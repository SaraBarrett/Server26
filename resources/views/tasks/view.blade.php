...
@section('content')
    <h5>Info / edição da task {{ $task->name }}</h5>
    ...
    <form method="POST" action="{{ route('tasks.update') }}">
        ...
        <div class="mb-3">
            ...
            <input name="name" value="{{ $task->name }}" required type="text" class="form-control" id="idname"
        ...
        <div class="mb-3">
            ...
            <input name="description" value="{{ $task->description }}" type="text" class="form-control" id="idname"
                aria-describedby="emailHelp">
